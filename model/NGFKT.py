...
def get_knowledge_embedding(item_inputs,embed_size,q_matrix):
...
class NGFKT(nn.Module):
    ...
    def get_inputs(self, q_matrix,item_inputs, label_inputs):
        item_inputs = get_knowledge_embedding(item_inputs,self.embed_size,q_matrix)
    ...
    def forward(self, q_matrix, item_inputs, label_inputs, item_ids, rel, timestamp):
       
        inputs = self.get_inputs(q_matrix,item_inputs, label_inputs)
